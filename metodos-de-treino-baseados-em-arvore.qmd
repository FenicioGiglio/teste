...
\$\text{valores de saída} = \frac{\sum \text{soma dos resíduos}}{\text{número de resíduos} + \lambda} \$. Repare que essa fórmula é bem parecida com a do índice de similaridade, mas a soma dos resíduos não está ao quadrado.
...
$\text{Cover} = \sum_{i = 1}^n [\text{Probabilidade Prévia}_i \times (1 - \text{Probabilidade Prévia}_i)] $
